...
// The Notification Platform's owned in-app store (WP-N2A). Hybrid identity: a fast bigint `id` for the PK/joins and
// a public `uuid` for the Center handle. One row per recipient (fan-out). Written only by the InApp channel.
